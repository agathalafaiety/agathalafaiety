...
- ⚙️ Experiência no desenvolvimento de sistemas, em arquitetura de microsserviços e escalabilidade.
...
| :--- | :--- |
| **Linguagens** | `Python (Principal)`, `Java`, `C#`, `SQL` |
| **Backend & Frameworks** | `FastAPI`, `Flask`, `Django`, `PySpark` |
